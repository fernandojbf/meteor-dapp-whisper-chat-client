...
Meteor.startup(function () {
    ...
    web3.shh.filter({
        ...
        if (message.to === Whisper.getIdentity().identity) {
            ...
            // add to the users collectionssssss
            ...
            if (chatId &&
                (payload.type === 'invite' || payload.type === 'message') && !Chats.findOne(chatId) &&
    ...
    Chats.find({}).observe({
        ...
        added: function (newDocument) {
            ...
            watchers[newDocument._id].watch(function (error, message) {
                ...
                if (message.payload.from !== Whisper.getIdentity().identity && //  TODO: later change to message.from
                    ...
                    if ((message.payload.type === 'message' ||
                        message.payload.type === 'notification' || !message.payload.type) && !Messages.findOne(message.payload.id)) {
